...
//				'events' => $events,
				...
				'homeTeam' => [
						...
						'in1' =>$this->convertZero($home->attributes->in1),
						'in2' =>$this->convertZero($home->attributes->in2),
						'in3' =>$this->convertZero($home->attributes->in3),
						'in4' =>$this->convertZero($home->attributes->in4),
						'in5' =>$this->convertZero($home->attributes->in5),
						'in6' =>$this->convertZero($home->attributes->in6),
						'in7' =>$this->convertZero($home->attributes->in7),
						'in8' =>$this->convertZero($home->attributes->in8),
						'in9' =>$this->convertZero($home->attributes->in9),
						'hits' =>$home->attributes->hits,
						'errors' =>$this->convertZero($home->attributes->errors),
//						'extra' => isset(convertZero($home->attributes->extra)) ? $home->attributes->extra : 0,
						'stats' => null ,
				...
				'awayTeam' => [
						...
						'in1' =>$this->convertZero($away->attributes->in1),
						'in2' =>$this->convertZero($away->attributes->in2),
						'in3' =>$this->convertZero($away->attributes->in3),
						'in4' =>$this->convertZero($away->attributes->in4),
						'in5' =>$this->convertZero($away->attributes->in5),
						'in6' =>$this->convertZero($away->attributes->in6),
						'in7' =>$this->convertZero($away->attributes->in7),
						'in8' =>$this->convertZero($away->attributes->in8),
						'in9' =>$this->convertZero($away->attributes->in9),
						'hits' =>$this->convertZero($away->attributes->hits),
						'errors' =>$this->convertZero($away->attributes->errors), 
//						'extra' => isset(convertZero($away->attributes->extra)) ? $away->attributes->extra : 0,
						'stats' => null ,
