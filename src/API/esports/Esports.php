...
//			$events = null;
		...
		$home_goal = isset($home->attributes->score)?$this->convertZero($home->attributes->score) : $this->convertZero($home->attributes->totalscore);
		$away_goal =  isset($away->attributes->score)?$this->convertZero($away->attributes->score) : $this->convertZero($away->attributes->totalscore);;
		
		$json = [
				'sport' => 'esports',
				'API_id' => isset($match->attributes->id) ? $match->attributes->id : '0',
				'id' => isset($match->attributes->id) ? $match->attributes->id : '0',
//				'ht_score' => $ht->attributes->score,
				...
				'injury_time' => null,
				'extra_time' => null,
				'competition_id' => isset($value->attributes->id) ? $value->attributes->id : 0,
				'venue_id' => null,
				'season_id' => null,
				'round_id' => null,
				'stage_id' => null,
...
//				'events' => $events,
				...
				'competition' => [
							'id' => isset($value->attributes->id)?$value->attributes->id:0,
							'cup' => null,
							'country_id' => null,
							'name' => isset($value->attributes->name) ?$value->attributes->name: 0,
							'active' => true,
						]
				];	
