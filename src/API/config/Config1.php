...
//	 
	...
	public $json_result = "http://78.46.64.77:1337/feeds/storage/live/{date}/{id}/{name}";
	
//	public $json_result = "http://78.46.64.77:1337/services/bak/365/storage/{date}/{id}/{name}";
	
	
	
	/*     */	
	public $results_status = ['ft', 'susp.', 'finished', 'cancelled', 'retired', 'interrupted'];
	/*     */	
	...
	public $remove_label_basket = ['1X2 Rest 1st Half', '1X2 Rest', 
								   'Asian Handicap',
									'over/under',
									'Double Chance',
	...
	public $remove_label_hockey= ['1X2 Rest 1st Half', '1X2 Rest'];
