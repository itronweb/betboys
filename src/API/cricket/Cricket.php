...
//						'toss' => isset(convertZero($home->attributes->toss)) ? $home->attributes->toss : 0,
						'runs' => $this->convertZero($home->attributes->runs),
						'score' => 0,
						'stats' => null ,
						],
				'awayTeam' => [
...
//						'toss' => isset(convertZero($away->attributes->toss)) ? $away->attributes->toss : 0,
						'runs' => $this->convertZero($away->attributes->runs),  
						'score' => 0,
						'stats' => null ,
						],
				'odds' => $odds,
