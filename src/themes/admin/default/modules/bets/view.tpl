<div id="page_content_inner">
    ...
    <div class="uk-width-medium-2-3 uk-margin-top uk-margin-bottom">
        <a href="{site_url|con:ADMIN_PATH:'/users'}" class="uk-button btn-breadcrumb">Openگشت</a>
    </div>
                                    ...
                                    {foreach $val->bet_form as $match}
                                        <ul class="detailbet">
                                            ...
                                            {if $match->bookmaker_id != 404}
                                                <li style="width:150px">
                                                    <a href="{site_url}bets/api/checkResultUpComingId/{$match->match_id}/{$match->bets_user_id}">بررسی مجدد تک Openی</a>
                                                </li>
                                                <li style="width:150px">
