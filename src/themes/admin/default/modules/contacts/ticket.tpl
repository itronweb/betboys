                    ...
                    <div data-uk-grid-margin="" class="uk-grid">
                        <div class="uk-width-medium-2-3">
                            <div class="uk-form-row">
                                ...
                                <div class="uk-margin-top">
                                    <h3 class="heading_c">Send به (انتخاب گروه Userی)</h3>
                                    <div class="uk-width-medium-1-1" data-uk-grid-margin="">
                                        <select id="role_selectize" class="data-md-closable-selectize" data-md-selectize-bottom="">
                                            <option value="">گروه Userی</option>
                                ...
                                <div class="uk-margin-top">
                                    <h3 class="heading_c">User دریافت کننده</h3>
                                    <div class="uk-width-medium-1-1" data-uk-grid-margin="">
                                ...
                                <div class="uk-margin-top uk-width-medium-1-1">
                                    <h3 class="heading_c">messege<span class="text-danger"> *</span></h3>
                    ...
                    <div class="uk-width-medium-1-4">
                       <input type="hidden" name="to" value="{$user_id}"/>
                        {if isset($user_id)}
                            <input type="hidden" name="to" value="{$user_id}"/>
                        {/if}
                        <button  type="submit" class="md-btn md-btn-flat md-btn-success btn-list"><span>Send</span></button>
