<div id="page_content_inner">
    ...
    <div class="uk-width-medium-2-3 uk-margin-top uk-margin-bottom">
        <a href="{site_url|con:ADMIN_PATH:'/contacts/contact-us'}" class="uk-button btn-breadcrumb">Openگشت</a>
    </div>
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-content">
            <div class="uk-overflow-container">
                <div class="uk-width-medium-1-1 uk-margin-top">
                    <label class="uk-text-italic uk-text-muted">Email تماس گیرنده: {$Contact.email}</label><hr>
                    <p>{$Contact.message}</p>
