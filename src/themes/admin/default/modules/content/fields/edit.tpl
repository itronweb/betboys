<div id="page_content_inner">
    <h3 class="heading_a title-top uk-margin-small-bottom">
        {($edit_mode) ? 'ویرایش User' : 'افزودن User'}
    </h3>
                        ...
                        <div class="md-card" data-uk-grid-margin>
                            <div class="md-card-content">
                                {if $edit_mode}
                                    {literal}
                                        <ul class="uk-tab" data-uk-tab="{connect:'#tabs_anim5', animation:'slide-right'}">
                                            <li class="uk-active"><a href="#">ویرایش User</a></li>
                                ...
                                {else}
                                    {literal}
                                        <ul class="uk-tab" data-uk-tab="{connect:'#tabs_anim5', animation:'slide-right'}">
                                            <li class="uk-active"><a href="#">افزودن User</a></li>
                                        </ul>
                                    {/literal}
                                {/if}
                                <ul id="tabs_anim5" class="uk-switcher uk-margin">
                                    <li>
                                        <div class="uk-width-medium-1-2 uk-float-right">
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-small-bottom">
                                                <div class="uk-form-row">
                                                    <label class="uk-form-label" for="phone">Tel</label>
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-small-bottom">
                                                <div class="uk-form-row">
                                                    <label class="uk-form-label" for="address2">Address 2</label>
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-small-bottom">
                                                <div class="uk-form-row">
                                                    <label for="status_disabled" class="inline-label">Status: </label>
                                        ...
                                        <div class="uk-width-medium-1-2 uk-float-left">
                                            <div class="uk-width-medium-5-6 uk-margin-small-bottom">
                                                <div class="uk-form-row">
                                                    <div class="uk-width-medium-2-5">
                                                        <label class="uk-form-label" for="roles"> گروه Userی</label>
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-small-bottom">
                                                <div class="uk-form-row">
                                                    <label class="uk-form-label" for="groups">Email</label>
