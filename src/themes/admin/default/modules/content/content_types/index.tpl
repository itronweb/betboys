            ...
            <table class="uk-table dataTable uk-table-striped" id="dt_default" role="grid" aria-describedby="dt_default_info">
                <thead>
                    <tr>
                        ...
                        <th class="sorting">Address لینک سئو</th>
                    ...
                    {foreach from=$Content_types item=val}
                        <tr>
                            ...
                            <td class="right">
                                ...
                                <a href="{site_url({ADMIN_PATH|con:'/content/extra-fields/list-fields/':$val.id})}" class="md-btn md-btn-small md-btn-warning" id="delete-btn">فیلد ها</a>
