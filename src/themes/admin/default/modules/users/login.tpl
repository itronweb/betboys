    ...
    <div class="md-card" id="login_card">
        ...
        <div class="md-card-content large-padding uk-position-relative" id="login_help" style="display: none">
            <button type="button" class="uk-position-top-right uk-close uk-margin-right uk-margin-top" id="login_help_close"></button>
                    ...
                    <p>برای دسترسی سریع به Profile خود می توانید یکی از کارهای زیر را انجام دهید:</p>
                    <p>اگر رمز عبور خود را به خاطر دارید اما نمی توانید به Profile خود وارد شوید، مطمئن شوید که کلید Capslock روشن نیست و نام Userی خود را صحیح وارد کرده اید.</p>
                    <p>اگر هنوز نمی توانید به Profile خود وارد شوید، می توانید برای <a href="#" id="login_password_reset_show">دریافت رمز عبور </a>اقدام کنید.</p>
        </div>
