    ...
    <div class="md-card  uk-margin-small-top">
        <div class="md-card-content">
            <div class="uk-width-medium-1-2 ">
                <a href="{site_url({ADMIN_PATH|con:'/users/users/edit'})}" class="md-btn md-btn-success">افزودن User</a>
            </div>
        </div>
    </div>
                            ...
                            *}<td>
                            ...
                            <td class="right">
                                ...
                                {if !$User->inRole(SUPER_ADMIN)}
                                    <a href="{site_url({ADMIN_PATH|con:'/users/users/delete/':$User->id})}" class="uk-icon-small uk-icon-hover uk-icon-close uk-text-danger delete" data-uk-tooltip title="حذف User" id="delete-btn"></a>
                                {/if}
