            ...
            <div class="col-md-12">
                <div class="breadcrumb">
                    <ul>
                        ...
                        <li><a href="{site_url|con:$entry.contentType.slug}">فروشگاه پیانویاب</a> <i class="fa fa-angle-left"></i></li>
                        <li>{$entry.title}</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 pull-right">
                ...
                <aside class="widget widget-categories">
                    <h3 class="sidebar-title">آرشیو تبلیغات</h3>
                    <ul class="sidebar-menu">
                        {foreach from=$content_type->entries item=shop}
                            <li><a href="{site_url()|con:'فروشگاه/':$shop.slug}">{$shop.title}</a></li>
                            {/foreach}
                    </ul>
                </aside>
            </div>
