...
<!--
									<div class="col-xs-12 centre amountinput perfectmoney hidden">
										<label class="col-lg-2 col-md-2  col-sm-12 col-xs-12 label" for="pmmemberid">Profile پرفکت مانی(ID) </label>
									...
									<div class="col-xs-12 centre amountinput perfectmoney hidden">
										<label class="col-lg-2 col-md-2  col-sm-12 col-xs-12 label" for="accountusd">Profile کیف پول (USD) </label>
