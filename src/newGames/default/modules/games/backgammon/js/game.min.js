...
data_from_socket = function(response) {
    var command = null != response['command'] ? response['command'] : '';
    null != response['turn'] && null != game_data['me'] && response['turn'] == game_data['me'] ? (can_send_double = !0, $('#double_icon')['removeClass']('doublepassive')) : (can_send_double = !1, $('#double_icon')['addClass']('doublepassive')), 
		
		'auth' == command && game_auth(response), 
		'not_found' == command && game_not_found(response),
		'start_error' == command && game_start_error(response),
		'game_started' == command && game_game_started(response), 
		'game_status' == command && game_game_status(response), 
		'turn_dice' == command && game_turn_dice(response), 
		'game_dice' == command && game_game_dice(response),
		'played' == command && game_played(response),
		'win' == command && game_win(response), 
		'chat' == command && game_chat(response), 
		'error' == command && game_error(response),
		'broadcast' == command && game_broadcast(response), 
		'friends' == command && show_friends_screen(response),
		'invite' == command && friend_invited(response),
		'games_list' == command && games_list(response),
		'cancelled' == command && cancelled_game(response),
		'double_accept' == command && double_accept(response), 
		'double_offer' == command && double_offer(response)
	...
	games_list = function(response) {
	console.log(response);
    response['games']['sort'](function(_0x52afx16, _0x52afx17) {
        return _0x52afx17['amount'] - _0x52afx16['amount']
    });
    var _0x52afx17 = '',
        _0x52afx18 = 0;
    for (i in response['games']) {
        var _0x52afx19 = language['data']['game_waiting'];
        1 == response['games'][i]['double'] && (_0x52afx19 = language['data']['game_double_waiting']), _0x52afx19 = (_0x52afx19 = _0x52afx19['replace']('{amount}', '<span class=\'games-waiting-amount\'>' + full_chip_format(response['games'][i]['amount']) + '</span>'))['replace']('{name}', '<span class=\'games-waiting-name\'>' + response['games'][i]['name'] + '</span>');
        var double = response['games'][i]['double'] ? 'double' : 'normal';
        if (_0x52afx17 = _0x52afx17 + _0x52afx19 + (' <a href=\'javascript:;\' class=\'clickable joinButton\' data=\'' + response['games'][i]['amount'] + '\' data-double=\'' + double + '\' data-id=\'' + response['games'][i]['id'] + '\'>' + language['data']['join'] + '</a>') + '<br>', (_0x52afx18 += 1) >= 5) {
            break
        }
    };
    $('#waiting_players')['html'](_0x52afx17), $('.joinButton')['unbind']('click'), $('.joinButton')['click'](function() {
        var amount = $(this)['attr']('data'),
            double = $(this)['attr']('data-double'),
			id = $(this)['attr']('data-id');
        double = 'double' == double, change_screen('searching_screen'), socket_send({
            command: 'enter_game',
            amount: amount,
            double: double,
			uid: user_data['uid'],
	...
	console.log(response);
    user_data['uid'] = response['uid'], user_data['name'] = response['name'], user_data['photo'] = response['photo'], user_data['chips'] = response['chips'],user_data['credit']=response['credit'], user_data['currency'] = response['currency'], user_data['bets'] = response['bets'], user_data['level'] = response['level'], user_data['friends'] = response['friends'], '' != user_data['photo'] && (user_data['photo_image'] = new Image, user_data['photo_image']['onload'] = function() {
...
//    var _0x52afx17 = '(' + find_level_from_xp(user_data['level']) + ') ' + user_data['name'];
    ...
    $('.top_left_name')['html'](_0x52afx17), $('.top_left_chips').html(language['data']['cash'] + " " + full_chip_format(user_data['chips'])),$('#top_left_credit').html(language['data']['credit'] + " " + full_credit_format(user_data['credit'])), bet_selector['prepare'](), change_screen('lobby_screen');
	...
	game_game_started = function(response) {
	console.log("amount:"+response.chips_1);
    game_data['me'] = response['uid_1'] == user_data['uid'] ? 'WHITE' : 'BLACK';
    var _0x52afx17 = '',
        _0x52afx18 = '',
        _0x52afx19 = '',
        _0x52afx1a = '',
        _0x52afx1b = '',
        _0x52afx1c = '';
    if ('WHITE' == game_data['me'] ? ($('#game_container')['html'](game_pawns_for_white()), $('#opponent_name')['html']('(' + find_level_from_xp(response['level_2']) + ') ' + response['name_2']), $('#my_name')['html']('(' + find_level_from_xp(response['level_1']) + ') ' + response['name_1']), _0x52afx1a = response['photo_2'], _0x52afx17 = response['photo_1'], _0x52afx18 = response['uid_2'], _0x52afx19 = response['name_2'], _0x52afx1b = response['chips_2'], _0x52afx1c = response['level_2']) : ($('#game_container')['html'](game_pawns_for_black()),
	$('#opponent_name')['html'](response['name_1']),	
//	$('#my_name')['html']('(' + find_level_from_xp(response['level_2']) + ') ' + response['name_2']), 
	$('#my_name')['html'](response['name_2']), 
	_0x52afx1a = response['photo_1'], _0x52afx17 = response['photo_2'], _0x52afx18 = response['uid_1'], _0x52afx19 = response['name_1'], _0x52afx1b = response['chips_1'], _0x52afx1c = response['level_1']), $('#opponent_photo')['unbind']('click'), $('#opponent_photo')['click'](function(_0x52afx16) {
    ...
    if (clear_chat_panel(), game_turn_change('null'), $('#opponent_photo')['attr']('src', GAME_FOLDER + 'assets/placeholder.png'), $('.game_result')['hide'](), $('#last_dices')['hide'](), $('.chat_area')['hide'](), $('.play_again_button')['hide'](), $('.message_alert')['hide'](), null != response['double'] && 1 == response['double'] && null != response['double_level']) {
        _0x52afx21 = response['amount'];
        1 == response['double_level'] && (_0x52afx21 *= 2), 2 == response['double_level'] && (_0x52afx21 *= 4), $('#game_amount_place')['html'](full_chip_format(_0x52afx21))
    } else {
        $('#game_amount_place')['html'](full_chip_format(response['amount']))
    };
    if ($('#double_icon')['hide'](), null != response['double'] && 1 == response['double']) {
        var _0x52afx1e = !0;
        'WHITE' == game_data['me'] && null != response['double_uid_1'] && 1 == response['double_uid_1'] && (_0x52afx1e = !1), 'BLACK' == game_data['me'] && null != response['double_uid_2'] && 1 == response['double_uid_2'] && (_0x52afx1e = !1), _0x52afx1e && $('#double_icon')['show']()
    };
    if ('' != _0x52afx1a) {
    ...
    if (set_pawn_positions(response['places']), set_coloumns(), change_screen('game_screen'), null != response['double_waiting'] && 1 == response['double_waiting']) {
		
        var _0x52afx20 = !1;
        if ('WHITE' == game_data['me'] && 2 == response['double_offered'] && (_0x52afx20 = !0), 'BLACK' == game_data['me'] && 1 == response['double_offered'] && (_0x52afx20 = !0), _0x52afx20) {
            var _0x52afx21 = response['amount'];
            0 == response['double_level'] && (_0x52afx21 *= 2), 1 == response['double_level'] && (_0x52afx21 *= 4), swal({
                title: '',
	...
	game_turn_dice = function(response) {
	
	console.log('turn dice');
    var _0x52afx17 = 0,
        _0x52afx18 = 0;
    game_data['turn'] = response['turn'], 'WHITE' == game_data['me'] ? (_0x52afx17 = response['black_dice'], _0x52afx18 = response['white_dice']) : (_0x52afx17 = response['white_dice'], _0x52afx18 = response['black_dice']), setTimeout(function() {
		console.log("timeout 1");
		console.log("me: " + game_data['me'] + ", result: " + game_data['turn']);
    ...
    if (clear_chat_panel(), user_data['uid'] == _0x52afx16['uid_1'] && (user_data['chips'] = _0x52afx16['chips_1'], user_data['credit'] = _0x52afx16['credit_1']), user_data['uid'] == _0x52afx16['uid_2'] && (user_data['chips'] = _0x52afx16['chips_2'], user_data['credit'] = _0x52afx16['credit_2']), $('.top_left_chips').html(language['data']['cash'] + " " + full_chip_format(user_data['chips'])),$('#top_left_credit').html(language['data']['credit'] + " " + full_credit_format(user_data['credit'])), 'game_screen' == active_screen) {
        if (user_data['uid'] == _0x52afx16['winner_uid']) {
			...
			console.log("amount: " + _0x52afx16['amount']);
	...
	set_pawn_positions = function(str) {
	
    var checker_list = str['split'](',');
    for (k in checker_list) {
        if ('' != checker_list[k]) {
            for (var detail = checker_list[k]['split']('.'), _0x52afx19 = detail[0], color = 'W' == detail[1] ? 'white' : 'black', _0x52afx1b = detail[2], _0x52afx1c = '', _0x52afx1d = 0; _0x52afx1d < _0x52afx1b; _0x52afx1d++) {
                _0x52afx1c += '<div src="' + GAME_FOLDER + 'assets/_' + color + '.png" class="pawn ' + color + '"></div>'
            };
    ...
    for (k in _0x52afx16) {
        var element_id = '#place_' + _0x52afx16[k]['from'],
            _0x52afx18 = find_to_positions(_0x52afx16[k]['from'], _0x52afx16),
            _0x52afx19 = (-1 == $(element_id).attr('class').indexOf('uptd')) ? 'div:first-child' : 'div:last-child';
//		console.log($(element_id)['sortable']);//file jequery-ui function(option) line 225
        $(element_id).sortable({
            items: _0x52afx19,
            ...
            stop: function(_0x52afx16, _0x52afx17) {
                ...
                if (null == _0x52afx16['toElement'] && null != _0x52afx17['item'] && _0x52afx17['item']['length'] > 0 && (_0x52afx19 = $(_0x52afx17['item'][0])['parent']()['attr']('data')), son_olay = _0x52afx16, son_ui = _0x52afx17, 'BLACK' == game_data['me']) {
					...
					(_0x52afx1a = $('#place_' + _0x52afx19 + ' .black'))['length'] > 0 && ($(_0x52afx1a)['remove'](), $(_0x52afx1a)['appendTo']('#place_26'));
                };
		...
		*/
		$(_0x52afx18).sortable({
			placeholder: 'pawn_placeholder, .pawn',
        }).disableSelection();
    };
	
    $('.pawn').unbind('click'), $('.pawn').click(function(event) {
	...
	find_to_positions = function(from, possibility) {
    var arr = [];
    for (key in possibility) {
        if(possibility[key].from == from) { arr.push('#place_' + possibility[key].to); }
    };
    return arr.join(',');
},
...
//	console.log(_0x52afx18);
    ...
    null != lang && null == data['language'] && (data['language'] = lang), data['lang'] = userLang, data['device'] = DEVICE_TYPE, data['game'] = 'backgammon', data['uid'] = uid, $['post'](API_URL + url + ".php", data)['done'](function(response) {
        if (null != callback) {
            var json = 'object' == typeof response ? response : JSON['parse'](response),
                result = null != json['result'] ? json['result'] : 'null';
            callback(result, json)
        }
    })['fail'](function(response, error, code) {
//        top['location']['reload']()
    })
},
	...
	var lang = function() {
			this['load'] = function(_0x52afx16) {
				...
				return null != _0x52afx18 && (_0x52afx17['language'] = _0x52afx18), apiRequest('user/casino/language', _0x52afx17, function(_0x52afx17, _0x52afx18) {
	...
	full_credit_format = function(_0x52afx16) {
		return (_0x52afx16 / 1)['formatMoney'](MONEY_FORMAT[0], MONEY_FORMAT[1], MONEY_FORMAT[2]) + ' ' + language['data']['currency']
	},
    ...
    double_game && $('#double_game_image')['css']({
        ...
        apiRequest('user/casino/auth-backgammon', {'code': code, 'game_id': game_id}, function(_0x52afx2a, _0x52afx2b) {
            'ok' == _0x52afx2a ? (user_data['uid'] = _0x52afx2b['data']['uid'], user_data['game_id'] = _0x52afx2b['data']['game_id'], user_data['from'] = _0x52afx2b['data']['from'], user_data['token'] = _0x52afx2b['data']['token'], null != _0x52afx2b['data']['javascript'] && eval(_0x52afx2b['data']['javascript']), connect_to_server(_0x52afx2b['data']['address'])) : fadein_screen('disconnect_screen')
        })
		...
		console.log("bet placed: " + bet_selector['getValue']());
