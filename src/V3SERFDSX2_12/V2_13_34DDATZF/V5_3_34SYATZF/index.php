<?php
  ...
  require_once '../../../V3SERFDSX2:12/api/RestApi/game.php';
  $game = new Game();
  $game->check_login();
  $db = new DB();
  ...
  $get_chips = 'موجودی ' . numberformat(file_get_contents($Sezar_CHIPS)) . ' تومان ';
...
<head>
  ...
  <link rel="shortcut icon" href="/V3SERFDSX2:12/default/modules/games/crash/assets/favicon.png" type="image/x-icon"/>
  <link rel="stylesheet" href="/V3SERFDSX2:12/default/assets/css/reset.css"/>
  <link rel="stylesheet" href="/V3SERFDSX2:12/default/assets/css/rangeslider.css"/>
  <link rel="stylesheet" href="/V3SERFDSX2:12/default/assets/css/sweetalert.css"/>
  <link rel="stylesheet" href="/V3SERFDSX2:12/default/modules/games/crash/css/style.css?000.002"/>

  <script type="text/javascript">
    var DEVICE_TYPE = 'browser';
    var MONEY_FORMAT = [0, '.', ','];
    var API_URL = 'http://136.243.255.205:3000/api/';
    var API_URL = '/V3SERFDSX2:12/api/';
    var GAME_FOLDER = '/V3SERFDSX2:12/default/modules/games/crash/';
    var HOME_URL = '/games';
    var MAIN_URL = '/';
  ...
  <script type="text/javascript" src="/V3SERFDSX2:12/default/assets/js/no-rightclick.js"></script>

  <script type="text/javascript" src="/V3SERFDSX2:12/default/assets/js/jquery.js"></script>
  <script type="text/javascript" src="/V3SERFDSX2:12/default/assets/js/rangeslider.min.js"></script>
  <script type="text/javascript" src="/V3SERFDSX2:12/default/assets/js/sweetalert.min.js"></script>
  <script type="text/javascript" src="/V3SERFDSX2:12/default/modules/games/crash/js/game.min.js?v=<?php echo gmdate("YmdHis"); ?>"></script>
...
<div id="main_container" class="main_container">
  ...
  <div id="splash_screen" class="screen">
    <table class="middle">
      <tr>
        <td>
          <img src="/V3SERFDSX2:12/default/modules/games/crash/assets/logo.png" class="logo">
        </td>
      </tr>
    </table>
  </div>
  ...
  <div id="loading_screen" class="screen hidden">
    <table class="middle">
      <tr>
        <td align="center">
          <img src="/V3SERFDSX2:12/default/modules/games/crash/assets/loading.png" class="loading"><br/>
          <center>
  ...
  <div id="disconnect_screen" class="screen hidden">
    <table class="middle">
      <tr>
        <td>
          <center>
            <img src="/V3SERFDSX2:12/default/modules/games/crash/assets/logo.png" height="100">
  ...
  <div id="lobby_screen" class="screen hidden">
    <div class="top_left_panel">
      <div class="left height_100">
        <img src="/V3SERFDSX2:12/default/modules/games/crash/assets/placeholder.png" class="profile_photo clickable settings_button" height="100%">
      </div>
    ...
    <div class="top_right_panel">
      <div class="right margin_r10 height_100">
        <img src="/V3SERFDSX2:12/default/modules/games/crash/assets/home.png" height="100%" class="clickable home_button">
      </div>
      <div class="clear"></div>
    </div>
          ...
          <div class="text-box cashout-amount-box">
            ...
            <div class="box-2-text" style="width: calc(100% - 80px); background: #fff;">
              <div style="padding-top: 10px; padding-left: 5px; padding-right: 5px;">
                <input type="range" class="range-slide" value="4" min="1.01" max="20" step="0.01"/>
              </div>
            </div>
            <div class="clear"></div>
          </div>
        ...
        <div class="chat-panel hidden">
          ...
          <div class="chat-text">
            <form method="post" action="#null" onSubmit="$('.chat-send').click(); return false;">
              ...
              <a href="javascript:;" class="chat-send"><img src="/V3SERFDSX2:12/default/modules/games/crash/assets/send.png?" height="24"></a>
            </form>
          </div>
        </div>
        <div class="clear"></div>
