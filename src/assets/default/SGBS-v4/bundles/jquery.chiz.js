...
$(document).ready(function() {
    var i, n;
    $(".balance span").html(convertDigit2Farsi($(".balance span").html()));
    i = 6e4;
    n = Math.floor(((new Date).getTime() - new Date($("#ServerTime").val()).getTime()) / i);
    ...
    var u = document.querySelector("div.digitalclock"),
            t = function(n) {
                return n < 10 ? "0" + n : n
            },
            r = function() {
                var n = new Date,
                        ...
                        f = t(n.getSeconds()),
                        e = [i, r, f].join(":");
                u.innerHTML = convertDigit2Farsi(e)
            };
    r();
    setInterval(r, 1e3);
    $(".changelang").click(function() {
        window.location = $(this).hasClass("fa") ? "/en" + window.location.pathname.toLowerCase().replace("/fa/", "/") : "/fa" + window.location.pathname.toLowerCase().replace("/en/", "/")
    })
})
