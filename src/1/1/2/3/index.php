<?php
  ...
  $Sezar_CHIPS = 'http://betinow.com/admincp/includes/SezarFunctions/SZR_Udata.php?id=' . $_SESSION['user_id'];
...
<head>
  ...
  <script type="text/javascript">
    ...
    var MONEY_FORMAT = [0, '.', ','];
    var API_URL = 'http://94.30.212.115:3000/api/';
    var API_URL = '/1/api/';
...
<div id="main_container" class="main_container">
  ...
  <div id="game_screen" class="screen hidden" style="background: #fff;">
    ...
    <div class="left-container">
	  ...
	  <h3 class="noselect" style="font-family:tahoma;">برترین برنده ها</h3>
	  <p class="noselect" style="color:#228B22;font-size:14px;font-family:tahoma;">842,540,000 20.25@ تومان @اریا کرمانشاه</p>
    <p class="noselect" style="color:#8B0000;font-size:14px;font-family:tahoma;">533,180,000 18.08@ تومان @اریا بکری</p>
    <p class="noselect" style="color:#1E90FF;font-size:14px;font-family:tahoma;">289,230,000 16.18@ تومان @مهلا لکزایی</p>

	  </div>
    <div class="clear mobile"  style="margin-left:40px;position:absolute;z-index:10px;left:0px;top:0px;">
	  <h3 class="noselect" style="font-family:tahoma;">برترین برنده ها</h3>
	  <p class="noselect" style="color:#228B22	;font-size:12px;font-family:tahoma;">842,540,000 20.25@ تومان @اریا کرمانشاه</p>
    <p class="noselect" style="color:#8B0000;font-size:12px;font-family:tahoma;">533,180,000 18.08@ تومان @اریا بکری</p>
    <p class="noselect" style="color:#1E90FF;font-size:12px;font-family:tahoma;">289,230,000 16.18@ تومان @مهلا لکزایی</p>
      ...
      <div class="game-bottom">
        ...
        <div class="tab-container mobile">
          ...
          <a href="javascript:;" class="chat-button tab-div-3">
			...
			<div class="crash-game-notification" style="margin: 5px; font-size: 12px; position: absolute; width: calc(50% - 10px); background: rgba(255,0,0,0.8); border: 1px solid #000; color: #fff;">
                                <div style="float: left; width: calc(20% - 30px); padding: 5px; line-height: 150%;">لطفا توجه فرمایید افرادی که برای شما در اینجا لینکی ارسال می کنند یا پیشنهاد بونوس و یا روش بازی انفجار را می فروشند اعتماد نکنید، این افراد سودجو سعی بر سرقت حساب کاربری شما و یا پول شما را دارند، با تشکر</div>
		...
		<div class="crash-game-notification" style="margin-left: 46px; font-size: 12px; position: absolute; width: calc(100% - 10px); background: rgba(255,0,0,0.8); border: 1px solid #000; color: #fff;width:320px;">
                                <div style="float: left; width: calc(100% - 30px); padding: 5px; line-height: 150%;">لطفا توجه فرمایید افرادی که برای شما در اینجا لینکی ارسال می کنند یا پیشنهاد بونوس و یا روش بازی انفجار را می فروشند اعتماد نکنید، باتشکر</div>
                                <div class="crash-game-notification-close" style="color: #000; float: left; width: 30px; padding: 10px; font-weight: bold; cursor: pointer;">X</div>
                            </div>
