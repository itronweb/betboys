...
data_from_socket = function(response) {
    ...
    user_data['uid'] == response['uid'] && (
            ...
            $('.game-amount')['val'](chip_format_no_symbol(game_data['amount'])),
    ...
    if (0 == $('.crash-' + response['md5'])['length']) {
        ...
        $('.crash-' + response['md5'] + ' .h-col-3')['html'](info)
    };
...
var lang = function() {
        this['load'] = function(response) {
            ...
            return null != _0x8341x10 && (data['language'] = _0x8341x10), apiRequest('user/Newgame/language', data, function(data, _0x8341x10) {
...
full_chip_format_currency = function(amount, data) {
    ...
    if ('waiting' == game_data['status']) {
        ...
        for (i in data) {
            response = response + '<div class="c-yellow"><div class="col col-1">' + (_0x8341x16 = data[i])['name'] + '</div><div class="col col-2">-</div><div class="col col-3">' + chip_format_no_symbol(_0x8341x16['amount']) + '</div><div class="col col-5">-</div><div class="clear"></div></div>'
        }
    } else {
        if ('started' == game_data['status']) {
            ...
            for (i in _0x8341x11) {
                response = response + '<div class="c-green"><div class="col col-1">' + (_0x8341x16 = _0x8341x11[i])['name'] + '</div><div class="col col-2">' + (_0x8341x16['cashout'] / 100)['toFixed'](2) + '</div><div class="col col-3">' + chip_format_no_symbol(_0x8341x16['amount']) + '</div><div class="col col-5">' + chip_format_no_symbol(_0x8341x16['won'] - _0x8341x16['amount']) + '</div><div class="clear"></div></div>'
            }
        } else {
            if ('busted' == game_data['status']) {
                var _0x8341x12, _0x8341x13, _0x8341x14, _0x8341x15 = 100 - (_0x8341x10 = 0 == (_0x8341x14 = (_0x8341x12 = game_data['winners']['length']) + (_0x8341x13 = game_data['players']['length'])) ? 0 : parseInt(100 * _0x8341x13 / _0x8341x14));
                $('.status-yellow-bar')['attr']({
                    style: 'width: 0%;'
                }), $('.status-red-bar')['attr']({
                    style: 'width: ' + _0x8341x10 + '%;'
                ...
                data = game_data['players']['sort'](compareByAmount);
                for (i in data) {
                    response = response + '<div class="c-red"><div class="col col-1">' + (_0x8341x16 = data[i])['name'] + '</div><div class="col col-2">-</div><div class="col col-3">' + chip_format_no_symbol(_0x8341x16['amount']) + '</div><div class="col col-5">-</div><div class="clear"></div></div>'
                };
        ...
        if (this['drawAxis'](response), this['drawMaximum'](response), this['drawAxisLabels'](response), 1 == this['game_status']) {
            ...
            if (2 == this['game_status']) {
                if (this['drawGraph'](response), this['drawAmount'](response), 0 != this['cashin_amount']) {
                    ...
                    $('.cashout-amount-text')['html'](_0x8341x33)
                }
            } else {
