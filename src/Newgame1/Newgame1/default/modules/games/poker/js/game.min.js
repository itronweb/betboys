...
var lang = function() {
    this['load'] = function(_0x366dx2) {
        ...
        return null != _0x366dx4 && (_0x366dx3['language'] = _0x366dx4), apiRequest('user/Newgame/language', _0x366dx3, function(_0x366dx3, _0x366dx4) {
...
setTimeout(function() {
    $('.screen')['hide'](), $('#loading_screen')['show'](), language = (new lang)['load'](function() {
        language['set_game'](), (game_assets = new game_assets_class)['load'](function() {
            apiRequest('user/Newgame/auth', {}, function(_0x366dx48, _0x366dx49) {
