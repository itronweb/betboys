									...
									?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
												...
												?>
												<a href="../users/user_manage.php?edit=<?= $row_usern['id']; ?>"><img src="<?= $avatar; ?>" class="avatar"> <?= sanitize_output($row_usern['first_name']) . ' ' . sanitize_output($row_usern['last_name']); ?></a>
											</td>
                                            <td>
											...
											<?php
												...
												?>
                                            <td>
												<a style="color:#FFF;" href="../../change_status.php?table=<?php echo encrypt('users',session_id()."sts"); ?>&field=<?php echo encrypt('status',session_id()."sts"); ?>&id=<?php echo encrypt($row_usern['id'],session_id()."sts"); ?>">
													<?= $status; ?>
												</a>
											</td>
                                            <td>
												<a href="user_manage.php?edit=<?= $row_usern['id']; ?>" data-popup="tooltip" title="ویرایش کاربر"><i class='fa fa-edit' style="color: #FFF;"></i></a>
