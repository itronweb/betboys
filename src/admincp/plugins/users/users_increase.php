<?php 
   GLOBAL $content;
   $content['title']       = "افزایش موجودی کاربر";
   ...
   $desc="افزایش شارژ حساب توسط مدیریت";
   }
   $price=$row_Recordsetadmid['cash'];
   $price=$price+$_POST['cash'];
   ...
   $ins_adm->addColumn("invoice_type", "NUMERIC_TYPE", "VALUE",10);
   $ins_adm->addColumn("description", "STRING_TYPE", "VALUE",$desc);
   $ins_adm->addColumn("trans_id", "STRING_TYPE", "VALUE",'ADMIN_INCREASE' . time());
