...
$newstatus=1;
elseif($row_rs1[$field]==NULL or !(isset($row_rs1[$field])) or $row_rs1[$field]==""){ $newstatus=0;}
...
echo "<script>window.location='".$_SERVER['HTTP_REFERER']."';</script>";
	...
	$newstatus=0;
    $query_RecordstatusInsert = "insert into $table (`id`, `status`) VALUES (".GetSQLValueString($colname_rs1, "text").",$newstatus)";
