<?php 
   GLOBAL $content;
   $content['title']       = "لیست بازی های زنده";
   require('../../layouts/sidebar.php');
   // Make unified connection variable
   
   $jsonResult = file_get_contents('../../../upload/API/soccer/inplay.json');
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <?php $y=substr($s,0,4);$mo=substr($s,5,2);$d=substr($s,8,2);$h=substr($s,11,2); $m=substr($s,14,2);$se=substr($s,17,2); ?>
                  ...
                  <tr>
                     ...
                     <td>
                        <ul class="icons-list">
                           <?php if (in_array('game_code', $accccesslist)) {?>
                           <li class="text-brown-600"><a href="game_code.php?hometeam=<?php echo $hometeam.'&awayteam='.$awayteam;?>&id=<?php echo encrypt($value['id'],session_id()."game"); ?>" data-popup="tooltip" title="کد کوتاه"><i class='fa fa-edit' style="color: #FFF;"></i></a></li>
                           <?php }?>
                           <?php if (in_array('game_status', $accccesslist)) {?>
