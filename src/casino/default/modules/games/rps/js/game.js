...
var lang = function() {
    this['load'] = function(_0xb679x2) {
        ...
        return null != _0xb679x7 && (_0xb679x3['language'] = _0xb679x7), apiRequest('user/casino/language', _0xb679x3, function(_0xb679x3, _0xb679x7) {
    ...
    start_game(function() {
        ...
        (assets = new assets_element)['load'](_0xb679x1f, function(_0xb679x22, _0xb679x23) {
            $('.loading_bar')['show'](), $('#loading_indicator')['width'](1.5 * _0xb679x23), _0xb679x22 && (sounds_mute && $('.button_sounds')['attr']({
                src: assets['get']('soundc')['src']
            }), apiRequest('user/casino/auth', {'code': code, 'game_id': game_id}, function(_0xb679x24, _0xb679x25) {
