...
//Base64 String To Image Function
//Coded By SezarMoein
	function B64IMG($data64){ 
		$data = str_replace('data:image/png;base64,', '', $data64);
	...
	function SZRNameFILE($file){
		$SZRName	=	'SZR-'.random_string().'-'.$file;
		return $SZRName;
	}
?>