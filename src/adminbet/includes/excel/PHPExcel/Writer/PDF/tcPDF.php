...
//		$fontname = $pdf->addTTFfont('../../Shared/PDF/fonts/hiwebmitra.ttf', 'TrueTypeUnicode', '', 32);
//		TCPDF_FONTS::addTTFfont('../../Shared/PDF/fonts/hiwebmitra.ttf', 'TrueTypeUnicode', '', 32);
//		$fontname = $pdf->addTTFfont('../../Shared/PDF/fonts/hiwebmitra.ttf', 'TrueTypeUnicode', '', 32);
//		$fontname = $pdf->addfont('../../Shared/PDF/fonts/hiwebmitra.php');
//		TCPDF_FONTS::addTTFfont('../../Shared/PDF/fonts/hiwebmitra.ttf', '', '', 32);
//		TCPDF_FONTS::addTTFfont('../../Shared/PDF/fonts/hiwebnazanin.ttf', '', '', 32);
		
//    	$newFont = "BMitra";
//    	$pdf->AddFont($newFont, '', $newFont . ".php");
//    	$pdf->SetFont($newFont);
    
//		var_dump($pdf->addTTFfont('../../Shared/PDF/fonts/BMitra.ttf', '', '', 32)) ;
//	var_dump($fontname);
//		$pdf->addFont();
//		var_dump($fontname);
