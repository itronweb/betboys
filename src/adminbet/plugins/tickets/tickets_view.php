      ...
      <div class="row">
                        ...
                        <div>
                            <?php
								...
								$avatar    = !empty($row_insta['avatar']) ? $row_insta['avatar'] : $Sezar_Theme_Link .'images/user.png';
                            ...
                            <div class="col-md-12" style="width:80%; float:<?= $row_ticketcomment['admin'] == 1 ? 'right' : 'left' ?>">
                                <div class="panel">
                                    <div class="panel-heading">
                                        ...
                                        <span>
                                            <a <?= $row_ticketcomment['admin'] == 1 ? 'admin' : 'href="../users/user_manage.php?edit='.$user_id.'"' ?>>
												<?= $name; ?>
											</a>
