...
$id= trim(decrypt($_GET['id'],session_id()."sprt"));
...
$upd_sprt = new tNG_update($conn_cn);
$tNGs->addTransaction($upd_sprt);
// Register triggers
$upd_sprt->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Update1");
$upd_sprt->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$upd_sprt->registerTrigger("END", "Trigger_Default_Redirect", 99, "sports_list.php");
$upd_sprt->registerTrigger("AFTER", "Trigger_ImageUpload", 97);

// Add columns
$upd_sprt->setTable("sports");
$upd_sprt->addColumn("name", "STRING_TYPE", "POST", "name");
$upd_sprt->addColumn("name_en", "STRING_TYPE", "VALUE", $name_en);
$upd_sprt->addColumn("name_inplay", "STRING_TYPE", "VALUE", $name_inplay);
$upd_sprt->addColumn("name_prematch", "STRING_TYPE","VALUE", $name_prematch);
$upd_sprt->addColumn("name_result", "STRING_TYPE", "VALUE", $name_result);
$upd_sprt->addColumn("is_inplay", "STRING_TYPE", "POST", "is_inplay");
$upd_sprt->addColumn("is_upcoming", "STRING_TYPE", "POST", "is_upcoming");
$upd_sprt->addColumn("default_bookmaker", "STRING_TYPE", "VALUE", $default_bookmaker);
$upd_sprt->addColumn("logo","FILE_TYPE", "FILES", "logo");
$upd_sprt->addColumn("sort", "NUMERIC_TYPE", "POST", "sort");
$upd_sprt->addColumn("status", "STRING_TYPE", "POST", "status");
$upd_sprt->setPrimaryKey("id", "NUMERIC_TYPE", "VALUE", $id);
...
<?php 
	...
	<div class="media-right col-xs-6 col-xs-push-2" style="margin: 2em auto;">
												
		<img src="<?php echo( "../../../attachment/sport_logo/". KT_escapeAttribute($row_rssprt['logo'])); ?>" style="width: 100%;height: 100%;border-radius: 2px;margin:  0 auto;" alt="" />
	</div>
												</div>
											</div>
										</fieldset>
										...
										<fieldset>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input name="is_upcoming" id="is_upcoming" type="radio" class="styled" value="0"  <?php if (!(strcmp(0, KT_escapeAttribute($row_rssprt['is_upcoming'])))) {echo 'checked="checked"';} ?> tabindex="10" />
                                                        غیرفعال
                                                    </label>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input name="is_inplay" id="is_inplay" type="radio" class="styled" value="0"  <?php if (!(strcmp(0, KT_escapeAttribute($row_rssprt['is_inplay'])))) {echo 'checked="checked"';} ?> tabindex="12" />
                                                        غیرفعال
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <label class="radio-inline">
                                                        <input name="status" id="status" type="radio" class="styled" value="1" <?php if (!(strcmp(1, KT_escapeAttribute($row_rssprt['status'])))) {echo 'checked="checked"';} ?> tabindex="13" />
                                                        فعال
                                                    </label>
                                                    <label class="radio-inline">
								...
								<div class="text-right">
                                    <button id="KT_Update1" name="KT_Update1" type="submit" class="btn btn-primary" tabindex="7">ویرایش اطلاعات <i class="icon-arrow-left13 position-right"></i></button>
								</div>
						</div>
                        </div>
