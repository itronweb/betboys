...
/**
 * Description of FoldTrait
 *
 */
trait FoldTrait {

    public function calc1Fold ( $bet ) {
        $c = count($bet);
        $indexes = array();
        $sumOdd = array();
        for ( $i = 1; $i <= $c; $i++ ) {
