...
{	
    ...
    private function _overview()
    {
        ...
        return $this->load->view('analytics/overview', $data, TRUE);
    }
    ...
    private function _referrers()
    {
        ...
        return $this->load->view('analytics/generic_table', $data, TRUE);
    }
    ...
    private function _top_content()
    {
        ...
        return $this->load->view('analytics/top_content', $data, TRUE);
    }
